...
public class Campus extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(nombreUsuario == null || nombreUsuario.length() == 0){
            JOptionPane.showMessageDialog(Campus.this, "El campo Usuario no puede estar vacio.", "Error", JOptionPane.ERROR_MESSAGE);
        }
        else{
            ...
            try {
                ...
                JOptionPane.showMessageDialog(Campus.this, "Campus agregado correctamente.", "Completado", JOptionPane.INFORMATION_MESSAGE);
                limpiarCombobox();
                llenarComboBox();
                txtUsuario.setText("");
                // Cerrar recursos
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if(selectedIndex == -1){
            JOptionPane.showMessageDialog(Campus.this, "Debe seleccionar un elemento.", "Error", JOptionPane.ERROR_MESSAGE);
        }
        else{
            ...
            try {
                ...
                JOptionPane.showMessageDialog(Campus.this, "Campus eliminado correctamente.", "Completado", JOptionPane.INFORMATION_MESSAGE);
                limpiarCombobox();
                llenarComboBox();
